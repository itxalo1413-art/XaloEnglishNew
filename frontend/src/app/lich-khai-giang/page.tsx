    ...
    <>
      ...
      <main className="flex-1 overflow-hidden bg-[var(--background)]">
        ...
        <section className="relative overflow-hidden py-16 sm:py-24">
          <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[var(--primary)]/5 via-transparent to-transparent" />
                ...
                <div key={row.id} className="group relative flex flex-col overflow-hidden rounded-[2rem] bg-white text-[var(--foreground)] shadow-xl shadow-black/5 ring-1 ring-black/5 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-black/10">
                  ...
                  <div className="relative aspect-[4/3] w-full overflow-hidden bg-[var(--surface-1)]">
                    {row.imagePlaceholder ? (
                      ...
                      <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-[var(--surface-1)] to-[#e2e8f0] p-6 text-center text-sm text-[var(--muted)] transition-transform duration-700 group-hover:scale-105">
                        <p>
